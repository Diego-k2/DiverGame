	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="cadastrarBdProduto.php" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Um criador é necessario">
						<input class="input100" type="text" name="criador">
						<span class="focus-input100"></span>
						<span class="label-input100">Criador</span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Uma classificação é necessaria">
						<input class="input100" type="text" name="classificacao">
						<span class="focus-input100"></span>
						<span class="label-input100">Classificação</span>
					</div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Um formato é necessario">
						<input class="input100" type="text" name="formato">
						<span class="focus-input100"></span>
						<span class="label-input100">Formato</span>
					</div>
